...
<nav className="navbar" role="navigation" aria-label="main navigation">
  ...
  <div id="navbarBasicExample" className="navbar-menu">
    <div className="navbar-start">
     ...
     {auth != true ? null :  <Link className="navbar-item"  to="/apply">Apply</Link>}

   <Link  className="navbar-item"  to="/identificator">Identificator</Link>
 ...
 <div className="container">
  ...
  {auth != true ? null : <Route path="/apply" component={SendData} />}
  <Route path="/register" component={Register} />
  <Route path="/login" render={() =><Login toggleAuth={toggleAuth}/>} />
  <Route path="/contact" component={Contact} />
  <Route path="/identificator" component={SpecificCompany} />
